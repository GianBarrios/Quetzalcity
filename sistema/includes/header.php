...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<div id="content-wrapper" class="d-flex flex-column" >
			...
			<div id="content">
				<!-- Topbar -->
				<nav class="navbar navbar-expand navbar-light text-white topbar mb-4 static-top shadow" style="background:#45B39D">

					<!-- Sidebar Toggle (Topbar) -->
					<button id="sidebarToggleTop" class="btn btn-link d-md-none rounded-circle mr-3">
						<i class="fa fa-bars"></i>
					</button>
					<div class="input-group" style="background:#45B39D" >
						<h2>Informacion General</h2>
						<p class="ml-auto"><strong>El tumbador, </strong><?php echo fechaPeru(); ?></p>
					</div>

					<!-- Topbar Navbar -->
					<ul class="navbar-nav ml-auto" style="background:#45B39D">
						...
						<li class="nav-item dropdown no-arrow">
							...
							<div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown" style="background:#45B39D">
