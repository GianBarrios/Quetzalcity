...
<div class="container-fluid" >
	...
	<div class="row" >
		<div class="col-lg-6" >
			<div class="card">
				<div class="card-header text-white" style="background:#45B39D" >
				...
				<div class="card-body">
					...
					<ul class="list-group" >
						<li class="list-group-item active" style="background:#45B39D">Cambiar Contraseña</li>
						<form action="" method=" post" name="frmChangePass" id="frmChangePass" class="p-3">
							...
							<div>
								<button type="submit" class="btn btn-primary btnChangePass" style="background:#45B39D">Cambiar Contraseña</button>
							</div>
						</form>
					</ul>
				</div>
				...
				<div class="card">
					...
					<div class="card-body">
						<form action="empresa.php" method="post" id="frmEmpresa" class="p-3">
							...
							<div>
								<button type="submit" class="btn btn-primary btnChangePass" style="background:#45B39D"><i class="fas fa-save"></i> Guardar Datos</button>
							</div>
